        ...
        <div className="rounded-[1.5rem] border border-border bg-surface/90 shadow-xl dark:shadow-[0_0_80px_rgba(255,255,255,0.02)] backdrop-blur-2xl overflow-hidden flex flex-col md:flex-row ring-1 ring-black/5 dark:ring-white/5">
          ...
          <div className="w-full md:w-56 border-r border-border bg-background/50 p-4 hidden md:flex flex-col gap-6">
            ...
            <div className="space-y-1">
              <p className="text-[10px] font-bold text-secondary/80 px-2 mb-3 uppercase tracking-widest block">Main Menu</p>
              ...
              <div className="flex items-center gap-3 px-3 py-2.5 text-secondary hover:text-primary transition-colors cursor-pointer text-sm font-medium">
          ...
          <div className="flex-1 p-5 md:p-6 flex flex-col gap-5">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center pb-4 border-b border-border gap-4 sm:gap-0">
              ...
              <div className="flex items-center gap-3 sm:gap-4 w-full sm:w-auto overflow-x-auto pb-1 sm:pb-0">
                <div className="flex items-center gap-2 bg-background/50 rounded-full px-4 py-1.5 border border-border min-w-[200px]">
                  ...
                  <span className="text-xs text-secondary/80">Search anything...</span>
                </div>
            ...
            <div className="flex gap-2 w-full overflow-x-auto border border-border rounded-xl bg-surface/50 p-1 text-[10px] md:text-xs font-mono hide-scrollbar">
              ...
              <div className="flex justify-between items-center px-4 py-1.5 border-r border-border min-w-[140px]">
                <span className="text-secondary">LTC</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Card className="p-5 flex flex-col justify-between bg-background/80 col-span-1 border-border rounded-2xl">
                <p className="text-secondary text-xs mb-2 flex items-center gap-2 font-medium uppercase tracking-wider"><Briefcase className="w-3.5 h-3.5"/> Wallet Balance</p>
                <div className="flex justify-between items-start mb-6">
                  <h3 className="text-3xl sm:text-4xl font-bold text-primary tracking-tight">$227,169<span className="text-secondary/80 font-medium">.85</span> <span className="text-[10px] font-medium text-secondary/80 tracking-widest uppercase ml-1">USD</span></h3>
                </div>
                <div className="flex gap-2">
                  ...
                  <button className="flex-1 bg-surface border border-border text-primary py-2 rounded-lg text-xs font-bold hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors shadow-sm">More</button>
                </div>
              </Card>
              ...
              <div className="col-span-1 md:col-span-2 grid grid-cols-2 gap-4">
                 <Card className="p-5 border-border bg-background/80 flex flex-col justify-between relative overflow-hidden rounded-2xl group">
                    ...
                    <div>
                      ...
                      <p className="text-secondary text-xs mb-1 font-medium tracking-wide">BTC Balance</p>
                      <h4 className="text-xl sm:text-2xl font-bold text-primary">0.34545 <span className="text-[10px] font-medium text-secondary/80 uppercase tracking-widest">BTC</span></h4>
                    </div>
                    <p className="text-secondary text-[10px] mt-3 font-mono">≈ 21,900.84 USD</p>
                 </Card>
                 <Card className="p-5 border-border bg-background/80 flex flex-col justify-between relative overflow-hidden rounded-2xl group">
                    ...
                    <div>
                      ...
                      <p className="text-secondary text-xs mb-1 font-medium tracking-wide">ETH Balance</p>
                      <h4 className="text-xl sm:text-2xl font-bold text-primary">12.345 <span className="text-[10px] font-medium text-secondary/80 uppercase tracking-widest">ETH</span></h4>
                    </div>
                    <p className="text-secondary text-[10px] mt-3 font-mono">≈ 37,870.88 USD</p>
                 </Card>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
               ...
               <Card className="col-span-1 md:col-span-2 p-5 border-border bg-background/80 min-h-[260px] flex flex-col rounded-2xl">
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="flex gap-1 bg-surface p-1 rounded-lg border border-border">
                      ...
                      <span className="px-3 py-1 text-[10px] font-semibold rounded-md text-secondary/80 hover:text-primary cursor-pointer transition-colors">7D</span>
                      <span className="px-3 py-1 text-[10px] font-semibold rounded-md text-secondary/80 hover:text-primary cursor-pointer transition-colors">1M</span>
                      <span className="px-3 py-1 text-[10px] font-semibold rounded-md text-secondary/80 hover:text-primary cursor-pointer transition-colors">ALL</span>
                    </div>
                  </div>
               ...
               <Card className="col-span-1 p-5 border-border bg-background/80 flex flex-col rounded-2xl">
                  <div className="flex justify-between items-center mb-5">
                    ...
                    <div className="p-1.5 rounded-md bg-neutral-900 border border-neutral-800 text-secondary cursor-pointer hover:text-primary">
                  ...
                  <div className="space-y-3 mb-6 flex-1">
                    <div className="bg-background border border-border rounded-xl p-3 flex justify-between items-center group hover:border-neutral-700 transition-colors">
                      <div className="flex flex-col">
                        <span className="text-[10px] text-secondary/80 font-medium mb-1">You Pay</span>
                      ...
                      <div className="flex items-center gap-2 bg-surface border border-border px-3 py-1.5 rounded-lg text-xs font-semibold cursor-pointer hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors">
                        ...
                        USD <ChevronRight className="w-3 h-3 text-secondary/80" />
                      </div>
                    </div>
                    <div className="flex justify-center -my-4 relative z-10">
                      <div className="w-8 h-8 rounded-full bg-background border border-border flex items-center justify-center text-secondary hover:text-primary hover:border-neutral-400 cursor-pointer transition-colors shadow-md dark:shadow-black">
                        <Activity className="w-3.5 h-3.5 rotate-90" />
                      </div>
                    </div>
                    <div className="bg-background border border-border rounded-xl p-3 flex justify-between items-center group hover:border-neutral-700 transition-colors">
                      <div className="flex flex-col">
                        <span className="text-[10px] text-secondary/80 font-medium mb-1">You Receive</span>
                        <span className="text-xl sm:text-2xl font-bold text-primary">0.1883</span>
                      </div>
                      <div className="flex items-center gap-2 bg-surface border border-border px-3 py-1.5 rounded-lg text-xs font-semibold cursor-pointer hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors">
                        <span className="text-[#F7931A] text-sm">₿</span> BTC <ChevronRight className="w-3 h-3 text-secondary/80" />
                      </div>
                    </div>
                  </div>
