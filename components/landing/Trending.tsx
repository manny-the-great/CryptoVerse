...
export function Trending() {
  return (
    <section className="py-24 px-6 flex justify-center bg-background border-t border-border relative">
      ...
      <div className="w-full max-w-6xl relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {trendingCoins.map((coin, idx) => (
            <Card key={idx} className="p-5 flex flex-col justify-between hover:bg-surface/50 transition-colors border-border bg-surface/30">
